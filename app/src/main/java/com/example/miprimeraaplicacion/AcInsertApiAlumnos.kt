...
import com.example.miprimeraaplicacion.API_DuocIntegración.InsertarAlumnosAPI
...
class AcInsertApiAlumnos : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val edNombre: EditText = findViewById(R.id.et_nom)
        val edApellido: EditText = findViewById(R.id.et_apell)
        val spGrupo: Spinner = findViewById(R.id.spn_grupo)
        val spSeccion: Spinner = findViewById(R.id.spn_seccion)
        val btnSave : Button = findViewById(R.id.btn_enviar)
